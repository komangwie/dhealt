...
export default class PraktekDokterUnLogin extends Component {
    ...
    getJadwalPraktekDokter=()=>{
        ...
        fetch(MainStore.domain+"/index.php?pagetype=service&page=Web-Service-Tamu&idunit="+MainStore.IDUnit+"&action=getAntreanPraktek")
        .then((res)=>res.json())
        .then((response)=>{
